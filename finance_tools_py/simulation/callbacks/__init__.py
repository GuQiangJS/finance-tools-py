...
class Rolling_Future(CallBack):
    ...
    Examples:
        ...
        rolling_close_3_min:[nan nan  3.  4.  5. nan nan nan]
        rolling_close_3_max:[nan nan  5.  6.  7. nan nan nan]
        rolling_close_3_mean:[nan nan  4.  5.  6. nan nan nan]
        rolling_close_3_med:[nan nan  4.  5.  6. nan nan nan]
        rolling_close_3_mean/close:[ nan  nan 2.   1.67 1.5   nan  nan  nan]
        rolling_close_3_med/close:[ nan  nan 2.   1.67 1.5   nan  nan  nan]
        rolling_close_3_max/close:[ nan  nan 2.5  2.   1.75  nan  nan  nan]
        rolling_close_3_min/close:[ nan  nan 1.5  1.33 1.25  nan  nan  nan]
    """
    ...
    def on_preparing_data(self, data, **kwargs):
        ...
        r = data.shift(-self.timeperiod)[self.col_name].rolling(
            self.timeperiod)
        data[col_min] = r.min()
        data[col_max] = r.max()
        ...
        data[n_mean] = data[col_mean] / data[
            self.col_name]  # 未来n日的平均价。>1表示上涨，<1表示下跌
        data[n_med] = data[col_med] / data[
            self.col_name]  # 未来n日的中位数。>1表示上涨，<1表示下跌
