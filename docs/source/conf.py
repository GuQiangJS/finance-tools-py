...
# -*- coding: utf-8 -*-
#
# finance-tools-py documentation build configuration file, created by
...
version = finance_tools_py.__version__.split('+')[0]
# The full version, including alpha/beta/rc tags.
release = finance_tools_py.__version__
...
exclude_patterns = ['test_*', 'testDatas']
...
htmlhelp_basename = 'finance-tools-pydoc'
